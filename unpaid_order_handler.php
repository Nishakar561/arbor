...
<html lang="en">
    ...
    <?php
        $get_data = mysqli_query($con,"SELECT * FROM orders WHERE is_delivered='unpaid' ORDER BY order_date ASC");
        ?>
                        ...
                        ?>
                            ...
                            <td>
                                <form action="handler.php" method="POST">
                                    ...
                                    <input type="hidden" name="type" value="<?php echo $row['is_delivered']; ?>">
                                    <input type="submit" name="paid" class="btn btn-info" value="Paid">
                                </form>    
                            </td>
                            </tr>
                        <?php
