...
<html lang="en">
    ...
    <?php
        $get_data = mysqli_query($con,"SELECT * FROM orders WHERE is_delivered='no' ORDER BY order_date ASC");
        ?>
                        ...
                        ?>
                            ...
                            <td>
                                <form action="handler.php" method="POST">
                                    ...
                                    <input type="submit" name="yes" class="btn btn-info" value="Delivered">
                                </form>    
                            </td>
                            </tr>
                        <?php
